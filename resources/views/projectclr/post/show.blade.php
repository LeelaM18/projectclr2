...
<div class=" grid grid-cols-4 mt-2">
    <div class="col-span-1 bg-slate-200 rounded-md p-3">image</div>
    <div class="col-span-3 bg-slate-400 rounded-md p-3 ml-3">
        <img src="{{Storage::url('images/' .$post->slug. '.png')}}" >
    </div>
</div>
<div class=" grid grid-cols-4 mt-2">
